...
For PDFs, Input preview follows the current page controls and Annotated PDF preview follows
the successfully parsed range. This filtering is preview-only; the individual annotated-PDF
download and batch ZIP retain the complete annotated source PDF.
